...
import { ChevronLeft, ChevronRight, Sparkles, Calendar, Sun, Sunset, Moon as MoonIcon, ArrowRight, Edit } from "lucide-react";
...
const bookingData = {
    ...
    therapist: {
        name: "Sarah Jenkins",
        rating: "Top Rated",
        image: "https://lh3.googleusercontent.com/aida-public/AB6AXuBnE31B6UH1O0ZoORSDvHXqYMrfEQbzeSL7g4m9y6n0Q-eLuLf9Jm0mib5nmZDYQbiR2_XMtPV_HBQbdiXvTkGJYB_exmuxAIsYW-jKuVX25Vu8vhLvZUvIyurdZenRYjo2PBwXShdLQmvIvLGqxKcbyIaQ0MXdOdSo6lPa3bTqtQjFQDyF2xsHVS0kDiw1CJdpUA75Z7RMkYrvj77hH8U3EiIiE4XF6lZzUP-EF3oHwIQmqmOnn0mg9PCyXLSp7V-P_jhW_hzAwHpd",
    },
    price: 45000,
};
        ...
        <div className="w-full flex flex-col items-center min-h-screen bg-background-light dark:bg-background-dark">
            ...
            <div className="w-full max-w-[1200px] px-4 md:px-10 lg:px-20 xl:px-40 py-6">
                <div className="flex flex-wrap gap-2 items-center">
                    <a href="#" className="text-gray-500 dark:text-gray-400 hover:text-primary text-sm md:text-base font-medium flex items-center gap-1">
                    ...
                    <div className="flex-1 flex flex-col gap-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 text-base font-normal">
                                Choose a date and time for your appointment with {bookingData.therapist.name}.
                            </p>
                        </div>
                        ...
                        <div className="bg-white dark:bg-[#1a160d] rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 md:p-8 flex flex-col md:flex-row gap-10">
                            ...
                            <div className="flex-1 min-w-[300px]">
                                ...
                                <div className="mt-6 flex items-center justify-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        <div className="w-2 h-2 rounded-full bg-gray-300"></div> Booked
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="sticky top-24 bg-white dark:bg-[#1a160d] rounded-2xl shadow-lg border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col">
                            ...
                            <div className="h-32 w-full relative bg-gray-200">
                                ...
                                <div
                                    ...
                                    style={{
                                        backgroundImage:
                                            "url('https://lh3.googleusercontent.com/aida-public/AB6AXuBPH75krDbciAqt0dNOWaPAnuK5nPo65ydfB0FcUfdDe8NoPz_2gKFW2bGmMyx9eohFcgKYu9NsHUl8hnT6Nr-wdH7fRY6qsSOMLf-d7MR8BhMpG1gCuF7W0-sgu4y23Csxg3FdhSVnE5HTC9kHEHUrng4IeLkSeU73MJnwACv-xJ0K0WVYAxnePPi8ir_zHMnK5GgFfolXQ6iE1VNq1LlsFQDe9VAC4wacHUDWoEfhDRWszJFScmFkfs2XD9JMoEbKWxoVowdD3rwS')",
                                    }}
                                ></div>
                            </div>
                            ...
                            <div className="p-6 flex flex-col gap-6">
                                ...
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-[#181611] dark:text-white">{bookingData.service.name}</p>
                                        <p className="text-sm text-gray-500 dark:text-gray-400">{bookingData.service.duration}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 items-start">
                                    <div className="w-12 h-12 rounded-lg overflow-hidden bg-gray-200 flex-shrink-0">
                                        <img
                                            src={bookingData.therapist.image}
                                    ...
                                    <div>
                                        ...
                                        <p className="font-bold text-[#181611] dark:text-white">{bookingData.therapist.name}</p>
                                        <p className="text-sm text-gray-500 dark:text-gray-400">{bookingData.therapist.rating}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-sm text-gold font-bold">{selectedTime} PM</p>
                                    </div>
                                ...
                                <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl flex justify-between items-center border border-gray-100 dark:border-gray-700">
                                    ...
                                    <span className="font-black text-xl text-[#181611] dark:text-white">₦{bookingData.price.toLocaleString()}</span>
                                </div>

                                {/* Action Buttons */}
                                <div className="flex flex-col gap-3 pt-2">
                                    <button className="w-full h-12 bg-primary hover:brightness-105 text-white font-bold rounded-xl shadow-lg shadow-primary/20 transition-all flex items-center justify-center gap-2 group">
                                        Continue to Details
                                        <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                                    </button>
                                    <button className="w-full h-10 text-gray-500 dark:text-gray-400 font-medium hover:text-[#181611] dark:hover:text-white transition-colors text-sm">
                                        Go Back
                                    </button>
                                </div>
                            </div>
